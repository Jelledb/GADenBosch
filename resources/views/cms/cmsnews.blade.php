...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-5 newbutton">
            <a href="{{ url('cms/newNews') }}"><input type="submit" value="Nieuw nieuwsartikel maken"  name="submit"></a>
        </div>
    </div>
    <div class="row">
        <div class="container">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ url('cms/newNews') }}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
